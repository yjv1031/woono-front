...
const SETTER = 'counter/SETTER' as const;
const DECREASE = 'counter/DECREASE' as const;
const INCREASE_BY = 'counter/INCREASE_BY' as const;

// 액션 생성함수를 선언합니다
export const setter = (param: number) => ({
  type: SETTER,
  payload: param
});
...
function counter(
  ...
  switch (action.type) {
    case SETTER: // case 라고 입력하고 Ctrl + Space 를 누르면 어떤 종류의 action.type들이 있는지 확인 할 수 있습니다.
